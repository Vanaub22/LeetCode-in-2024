...
public:
    string numberToWords(int num) {
        ...
        str_num="";
        if(!billions.empty()) str_num+=billions+" Billion";
        if(!millions.empty()) str_num+=millions+" Million";
        if(!thousands.empty()) str_num+=thousands+" Thousand";
        if(!rest.empty()) str_num+=rest;
    ...
    string convert999(string num) {
        ...
        if(!hundreds.empty()) converted+=" "+hundreds+" Hundred";
        if(!tens.empty()) converted+=" "+tens;
        if(!ones.empty()) converted+=" "+ones;
        return converted;
    }
};